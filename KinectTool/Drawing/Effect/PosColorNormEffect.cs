...
{
    public class PosColorNormEffect:IEffect
    {
        ...
        {
            //Create effect
            var shaderSource = File.ReadAllText("Resources/Effects/PosColNorm3D.fx");
            ...
            InputLayout = new InputLayout(device,pass.Description.Signature,InputLayouts.PosColNorm);
